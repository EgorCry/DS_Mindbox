### В данном репозитории выполнено тестовое задание для компании mindbox.
...
#### Решение: создать две функции для решения задачи + дополнительную функцию для подсчёта суммы цифр в числе.
#### Выполнение программы не требует дополнительных библиотек для установки.